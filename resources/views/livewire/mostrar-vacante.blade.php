<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-700 p-4 my-10">
            ...
            <p class="font-bold text-sm uppercase text-gray-300 my-3">Último día para postularse:
                <span class="normal-case font-normal">{{$vacante->ultimo_dia->toFormattedDateString()}}</span>
            </p>

            <p class="font-bold text-sm uppercase text-gray-300 my-3">Categoría:
    ...
    <div class="md:grid md:grid-cols-6 gap-4">
        <div class="md:col-span-2 w-96 p-10">
            <img src="{{ asset('storage/vacantes/'.$vacante->imagen)}}" alt="{{'Imagen vacante '.$vacante->titulo}}"/>
        </div>
        <div class="md:col-span-4">
            <h2 class="text-2xl font-bold mb-5 text-gray-300">Descripción del Puesto</h2>
            <p class="text-gray-300 font-bold text-justify text-sm">{{$vacante->descripcion}}</p>
        </div>
    </div>
@guest
