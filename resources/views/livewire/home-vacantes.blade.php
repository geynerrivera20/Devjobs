<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extrabold text-4xl text-gray-300 mb-10">Nuestras Vacantes Disponibles</h3>

            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ( $vacantes as $vacante )
                <div class="md:flex md:justify-between md:items-center py-5">
                    <div class="md:flex-1">
                        <a class="text-3xl font-extrabold text-gray-500" href="{{route('vacantes.show',$vacante->id)}}">{{$vacante->titulo}}</a>
                    ...
                    <div class="mt-5 md:mt-0">
                        <a class="bg-indigo-600 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center" href="{{route('vacantes.show',$vacante->id)}}" > Ver Vacante</a>
                    </div>
                </div>
